...
//	GS-CS	1.00.18	JPN	0x00485060	-	Completed
//////////////////////////////////////////////////////////////////////
...
BOOL CSkillAdditionInfo::Load(LPSTR lpszFileName)
{
	...
	{
		LogAdd(LOG_BLACK, "[Skill Addition Info] - File load error : File Name Error");
		return FALSE;
	}
	...
	LogAdd(LOG_BLACK, "[Skill Addition Info] [Infinity Arrow] Skill Time[%d], UseLevel[%d], Arrow MP Consumption +0[%d] +1[%d] +2[%d]",
	...
	LogAdd(LOG_BLACK, "[Skill Addition Info] [Fire Scream] Use(%d) : Explosion Distance(%d) - Rate(%d), MaxAttack_SameSerial(%d), SerialInitCount(%d), Check Serial(%d)",
